...
def create_database():
    ...
    # 4. Таблица Бронирования (основная)
    cursor.execute('''
...
def insert_test_data(cursor):
    ...
    rooms = [
        ...
        ('RM002', '102', 'Стандарт', 2, 3500.00, 'Свободен', 1),
        ...
        ('RM006', '202', 'Полулюкс', 3, 5200.00, 'Свободен', 2),
        ('RM007', '203', 'Полулюкс', 3, 5200.00, 'Свободен', 2, '203.jpg'),
        ('RM008', '301', 'Люкс', 4, 8000.00, 'Свободен', 3, '301.jpg'),
        ('RM009', '302', 'Люкс', 4, 8500.00, 'Свободен', 3),
        ('RM010', '401', 'Апартаменты', 5, 12000.00, 'Свободен', 4),
    ]
...
def main():
    ...
    try:
        ...
        tables = ['Сотрудники', 'Клиенты', 'Номера', 'Бронирования', 'Счета']
        for table in tables:
